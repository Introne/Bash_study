...
## Re-root重置根
进化树可以用指定的外群重新根化。
作用：在较远的进化距离上体现物种的基因信息；

举个例子：
在homo基因组上发现某个基因由A突变为B，chimp上是A；如何判断该homo的基因是否是突变的？  
可以通过重置根，引入某个外类群显示该基因的信息，如果是A，那么homo的B可能是A突变来的。  
此外，还可以进一步观察该基因是否是来自祖先混合基因而来，即祖先上既有A，也有B。
...
进化树：https://www.jianshu.com/p/db8c8b00770b
